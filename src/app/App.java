...
public class App {
    public static void main(String[] args) {
        int tamañoPagina = 256;  // Ajusta el tamaño de página según sea necesario
        String nombreImagen = "archivos/caso2-parrots.bmp";  // Ruta relativa al archivo de imagen dentro del proyecto
